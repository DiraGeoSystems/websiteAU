...
## Analytics
**We do not collect any user data at the moment at all (but GitHub might).**<br>
We don't even use cookies. <br>
The language selection happens via a lang flag which is updated in all links through a js file.<br>
